namespace ProjectName
{
  public class MadLibVariable
  {
    ...
    public string ArticleOfClothing1 { get; set; }
    public string ArticleOfClothing2 { get; set; }
    ...
    public string TypeOfLiquid1 { get; set; }
    public string TypeOfLiquid2 { get; set; }
